...
int number = 20;//số lượt di truyền
int numberrandom = 500; //số lượt random dùng cho lời giải random
...
vector<int> average;//tập chứa độ tốt trung bình ở từng vòng đời
...
//tính độ tốt trung bình trong một thế hệ
...
int main(int argc, const char * argv[]) {
    ...
    //lưu cá thể max, trung bình ban đầu
    ...
    while (number--) {
        ...
        //Lưu lại cá thể max và trung bình từng thế hệ
    ...
    //In ra độ thích nghi lớn nhất và trung bình của mỗi vòng đời
